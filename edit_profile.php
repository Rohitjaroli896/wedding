				...
				<table class="table_working_hours">
		        	<tbody>
					    ...
					    <tr class="opened_1">
							...
							<td class="day_value"><input type="text" name="gender" value="<?= $r["gender"]?>" class="form-control" required></td>
						</tr>
					    ...
					    <tr class="opened_1">
							...
							<td class="day_value"><select name="religion" class="form-control">
					    ...
					    <tr class="opened_1">
							...
							<td class="day_value"><select name="caste" class="form-control">
					    ...
					    <tr class="opened_1">
							...
							<td class="day_value"><select name="state" class="form-control">
					    ...
					    <tr class="opened_1">
							...
							<td class="day_value closed"><select name="country" class="form-control">
						...
						<tr class="opened_1">
							...
							<td class="day_value"><input type="text" name="occu" value="<?= $r["occu"]?>" class="form-control" required></td>
						</tr>
						<tr class="opened_1">
							<td class="day_label">Age:</td>
							<td class="day_value"><input type="text" name="age" value="<?= $r["age"]?>" class="form-control" required></td>
						</tr>
					    <tr class="closed">
							<td class="day_label"></td>
							<td class="day_value closed"><input type="submit" value="update"</td>
						</tr>
				    </tbody>
				</table>
			</form>
