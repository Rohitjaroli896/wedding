...
<div class="grid_3">
  <div class="container">
   ...
   <div class="profile">
		...
		<?php
               $rs = mysqli_query($conn,"select * from cse_record where code='$code'");
					...
					<table class="table_working_hours">
						<tbody>
							...
							<tr class="closed">
								...
								<td class="day_value closed"><?= $r["city"]?></td>
							</tr>
							<tr class="closed">
								<td class="day_label">Country:</td>
								<td class="day_value closed"><?= $r["country"]?></td>
							</tr>
							<tr class="closed">
								<td class="day_label">Age:</td>
								<td class="day_value closed"><?= $r["age"]?></td>
							</tr>
						</tbody>
				    </table>
				<div>
				    <form method="post" action="msg.php?id=<?=$code?>">
					  ...
					  <textarea name="msg" class="form-control" style="resize:none"></textarea><br>
